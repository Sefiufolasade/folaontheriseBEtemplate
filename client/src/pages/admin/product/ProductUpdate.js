        ...
        <div className='row'>
            ...
            <div className='col-md-10'>
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <br/>
                    {category &&<div className='form-group'>
                        <label>Sub Categories</label>
                        <Select mode='multiple' className='form-control seLect' placeholder='Please Select' value={arrayOfSubsId} onChange={((value) => setArrayOfSubsId(value) )}>
