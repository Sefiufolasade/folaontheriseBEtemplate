...
const UpdateCategory = () => {
    ...
    const UpdateCategoryForm = () => <form onSubmit={handleSubmit}>
        <div className='form-group'>
            <br/>
            <label>Update Category</label>
            <input type='text' className='form-control' onChange={(e) => setName(e.target.value)} value={name} disabled={loading} autoFocus required/>
